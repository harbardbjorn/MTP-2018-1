...

{
	...
	do
	{
		printf("\naperte 1 para ... Cadastro\naperte 2 para ... Consulta\n");
		scanf("%d", &opt);
		getchar();
		...
		switch (opt)
		{
			...
			case 2:
				...
				if (strlen(p[menu-1].nome) == 0)
					...
					printf("\n%s, R$ %.2f, L: %.2fm x P: %.2fm x A: %.2fm", p[menu-1].nome, p[menu-1].preco, p[menu-1].dimen.l, p[menu-1].dimen.p, p[menu-1].dimen.h);
